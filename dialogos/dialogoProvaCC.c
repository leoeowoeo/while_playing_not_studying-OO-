...
void dialogoprovacc()
{
    ...
    beep(); refresh(); if(!skipado) napms(70);
    erase();
    slow_mvwprintw(stdscr, "alarme- BEEP BEEP BEEP", linha_atual, Xall, 50,&skipado);
    ...
    linha_atual++;
    slow_mvwprintw(stdscr, "Voce demora para levantar por estar lerdo", linha_atual, Xall, 50,&skipado);
    ...
    if (marcar_arrumar == 0)
    {
        ...
        refresh(); if(!skipado) napms(700);
        linha_atual++;
        slow_mvwprintw(stdscr, "pega o que ve pela frente que e vestivel e sai", linha_atual, Xall, 50,&skipado);
        ...
        refresh(); if(!skipado) napms(700);
        linha_atual++;
        slow_mvwprintw(stdscr, "Voce volta pra acertar as things", linha_atual, Xall, 50,&skipado);
    ...
    {
        slow_mvwprintw(stdscr, "Voce se arruma lentamente", linha_atual, Xall, 50,&skipado);
